    ...
    <div class="sidebar  text-white p-3">
      ...
      <div class="mt-auto">
        ...
        <div class="myacount">
          ...
          <router-link to="/admin/profile" class="nav-link text-white text-center">
...
const user = ref(null); // Biến để lưu thông tin người dùng
user.value = useUserStore().user; // Lấy thông tin người dùng từ store
...
.fixed {
  position: fixed;
  /* Đặt layout ở vị trí cố định */
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
  display: flex;
  /* Sử dụng flexbox để căn chỉnh sidebar và nội dung chính */
}
...
.sidebar {
  ...
  /* Ngăn sidebar co lại */
  display: flex;
  /* Sử dụng flexbox để căn chỉnh nội dung bên trong sidebar */
  flex-direction: column;
  /* Sắp xếp các mục theo cột */
...
.main-content {
  overflow-y: auto;
  /* Thêm scrollbar nếu nội dung quá dài */
}
