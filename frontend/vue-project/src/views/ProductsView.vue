...
const fetchProducts = async () => {
    ...
    // Dữ liệu giả lập:
    allProducts.value = [
        { id: 1, name: 'Giày Adidas Stan Smith White Green', price: '$95.50', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Adidas+Stan+Smith' },
        { id: 2, name: 'Áo Thun Nike Sportswear', price: '$30.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Ao+Thun+Nike' },
        { id: 3, name: 'Quần Jean Levis 501', price: '$70.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Quan+Jean+Levis' },
        { id: 4, name: 'Giày Nike Air Force 1 Low', price: '$100.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Nike+Air+Force+1' },
        { id: 5, name: 'Balo Adidas Classic', price: '$40.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Balo+Adidas' },
        { id: 6, name: 'Mũ Lưỡi Trai Nike', price: '$25.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Mu+Nike' },
        { id: 7, name: 'Tất Adidas Performance', price: '$15.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Tat+Adidas' },
        { id: 8, name: 'Áo Khoác Nike Windrunner', price: '$85.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Ao+Khoac+Nike' },
        { id: 9, name: 'Giày Converse Chuck Taylor', price: '$60.00', image: 'https://via.placeholder.com/150/f8f8f8/000000?text=Converse' },
        // ... thêm sản phẩm khác
    ];
