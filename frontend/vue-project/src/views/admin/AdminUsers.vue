        ...
        <div class="card-body">
          ...
          <div v-else>
            ...
            <div class="d-flex justify-content-center mt-3">
                <nav aria-label="Page navigation example">
                  <ul class="pagination shadow-sm rounded"> {/* Thêm shadow và bo tròn cho phân trang */}
                    <li class="page-item disabled"><a class="page-link" href="#">Trước</a></li> {/* Thêm disabled */}
                    <li class="page-item active"><a class="page-link" href="#">1</a></li> {/* Thêm active */}
                    {/* Thêm các trang giả khác nếu muốn */}
                    <li class="page-item disabled"><a class="page-link" href="#">2</a></li>
                    <li class="page-item disabled"><a class="page-link" href="#">3</a></li>
                    <li class="page-item disabled"><a class="page-link" href="#">Sau</a></li> {/* Thêm disabled */}
                  </ul>
                </nav>
            </div>
          </div>
